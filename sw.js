const CACHE="chizu-line-v2-50";
const FILES=["./","./index.html","./styles.css","./app.js","./speed-editor.js","./pan-motion.js","./route-data.js","./speed-data.js","./asset-data.js","./manifest.webmanifest","./icon.svg","./list-print.js","./list-print.css"];
