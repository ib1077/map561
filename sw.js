const CACHE="chizu-line-v2-44";
const FILES=["./","./index.html","./styles.css","./app.js","./pan-motion.js","./route-data.js","./speed-data.js","./asset-data.js","./manifest.webmanifest","./icon.svg","./list-print.js","./list-print.css"];
