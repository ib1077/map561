const CACHE="chizu-line-v2-34";
const FILES=["./","./index.html","./styles.css","./app.js","./route-data.js","./speed-data.js","./asset-data.js","./manifest.webmanifest","./icon.svg","./list-print.js","./list-print.css"];
